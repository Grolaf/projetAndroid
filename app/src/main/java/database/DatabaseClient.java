...
public class DatabaseClient {
    ...
    RoomDatabase.Callback roomDatabaseCallback = new RoomDatabase.Callback() {
        ...
        public void onCreate(@NonNull SupportSQLiteDatabase db) {
            ...
            db.execSQL("INSERT INTO qcm VALUES(" + 31 + ", \"Questions de calculs\", " + nv.fromNiveauToJson(Niveau.MOYEN) +", \"Maths\");");
            ...
            db.execSQL("INSERT INTO qcm VALUES(" + 32 + ", \"Questions de calculs\", " + nv.fromNiveauToJson(Niveau.MOYEN) +", \"Maths\");");
            ...
            db.execSQL("INSERT INTO qcm VALUES(" + 33 + ", \"Questions de cours\", " + nv.fromNiveauToJson(Niveau.DIFFICILE) +", \"Maths\");");
            ...
            db.execSQL("INSERT INTO qcm VALUES(" + 34 + ", \"Questions de cours\", " + nv.fromNiveauToJson(Niveau.DIFFICILE) +", \"Maths\");");
                ...
                // Anglais //
            db.execSQL("INSERT INTO qcm VALUES(" + 35 +", \"Vocabulaire\", " + nv.fromNiveauToJson(Niveau.FACILE) + ", \"Anglais\");");
            ...
            db.execSQL("INSERT INTO qcm VALUES(" + 36 +", \"Vocabulaire\", " + nv.fromNiveauToJson(Niveau.FACILE) + ", \"Anglais\");");
            ...
            db.execSQL("INSERT INTO qcm VALUES(" + 37 +", \"Vocabulaire\", " + nv.fromNiveauToJson(Niveau.MOYEN) + ", \"Anglais\");");
            ...
            db.execSQL("INSERT INTO qcm VALUES(" + 38 +", \"Vocabulaire\", " + nv.fromNiveauToJson(Niveau.DIFFICILE) + ", \"Anglais\");");
            ...
            db.execSQL("INSERT INTO qcm VALUES(" + 39 +", \"Conjugaison\", " + nv.fromNiveauToJson(Niveau.DIFFICILE) + ", \"Anglais\");");
            ...
            db.execSQL("INSERT INTO qcm VALUES(" + 40 +", \"Orthographe\", " + nv.fromNiveauToJson(Niveau.FACILE) + ", \"Français\");");
            ...
            db.execSQL("INSERT INTO qcm VALUES(" + 41 +", \"Divers\", " + nv.fromNiveauToJson(Niveau.FACILE) + ", \"Français\");");
            ...
            db.execSQL("INSERT INTO qcm VALUES(" + 42 +", \"Orthographe\", " + nv.fromNiveauToJson(Niveau.MOYEN) + ", \"Français\");");
            ...
            db.execSQL("INSERT INTO qcm VALUES(" + 43 +", \"Divers\", " + nv.fromNiveauToJson(Niveau.MOYEN) + ", \"Français\");");
            ...
            db.execSQL("INSERT INTO qcm VALUES(" + 44 +", \"Divers\", " + nv.fromNiveauToJson(Niveau.DIFFICILE) + ", \"Français\");");
            ...
            db.execSQL("INSERT INTO qcm VALUES(" + 45 +", \"Divers\", " + nv.fromNiveauToJson(Niveau.DIFFICILE) + ", \"Français\");");
            ...
            db.execSQL("INSERT INTO qcm VALUES(" + 46 +", \"Divers\", " + nv.fromNiveauToJson(Niveau.DIFFICILE) + ", \"Culture Générale\");");
            ...
            db.execSQL("INSERT INTO qcm VALUES(" + 47 +", \"Divers\", " + nv.fromNiveauToJson(Niveau.DIFFICILE) + ", \"Culture Générale\");");
            ...
            db.execSQL("INSERT INTO qcm VALUES(" + 48 +", \"Dates\", " + nv.fromNiveauToJson(Niveau.FACILE) + ", \"Histoire\");");
            ...
            db.execSQL("INSERT INTO qcm VALUES(" + 49 +", \"Rois de France\", " + nv.fromNiveauToJson(Niveau.FACILE) + ", \"Histoire\");");
            ...
            db.execSQL("INSERT INTO qcm VALUES(" + 50 +", \"Guerres\", " + nv.fromNiveauToJson(Niveau.MOYEN) + ", \"Histoire\");");
            ...
            db.execSQL("INSERT INTO qcm VALUES(" + 51 +", \"Exploration\", " + nv.fromNiveauToJson(Niveau.MOYEN) + ", \"Histoire\");");
            ...
            db.execSQL("INSERT INTO qcm VALUES(" + 52 +", \"Amériques\", " + nv.fromNiveauToJson(Niveau.MOYEN) + ", \"Histoire\");");
            ...
            db.execSQL("INSERT INTO qcm VALUES(" + 53 +", \"Divers\", " + nv.fromNiveauToJson(Niveau.DIFFICILE) + ", \"Histoire\");");
